...
var validators = module.exports = {
	...
	bool: function (val, eq) {
		var bool = fn.parseBoolean(val);
		if (bool !== null) {
			if (eq !== undefined) {
				return (bool === eq) || 'Not a boolean equal to "' + eq + '".';
			} else {
				return true;
			}
		} else {
	...
	'int': function (val) {
		return validators.number(val, 1, 1099511627776);	// 4-byte unsigned int
	},
